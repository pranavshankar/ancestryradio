...
function inject_spotify_button() {
  ...
  $('#spotify_link').click(function() { window.open("http://www.ancestryradio.me/radio?birthYear=" + get_birth_year() + "&name=" + get_first_name() + "&lastName=" + get_last_name() + "&imgUrl=" + get_image_url(), "_blank");} );
